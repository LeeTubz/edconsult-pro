    ...
    if (resendApiKey) {
      try {
        ...
        await resend.emails.send({
          from: "Platinum Accolades <noreply@platinumaccolades.com>",
          to: [process.env.CONTACT_EMAIL || "knowledgelab.bw@gmail.com"],
          subject: `New Consultation Request from ${fullName}`,
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
              <div style="background: linear-gradient(135deg, #0F2545, #0F2F57); padding: 32px; border-radius: 12px 12px 0 0;">
                <h1 style="color: white; margin: 0; font-size: 24px;">New Consultation Request</h1>
                <p style="color: rgba(255,255,255,0.7); margin: 8px 0 0;">Platinum Accolades | Educational Consultancy</p>
              </div>
              <div style="background: #F8F4F0; padding: 32px; border-radius: 0 0 12px 12px; border: 1px solid #dde4d0;">
                ...
                <div style="margin-top: 24px; padding: 16px; background: #eef2e8; border-radius: 8px; border: 1px solid #cdd8c2;">
                  <p style="margin: 0; color: #0F2F57; font-size: 14px;">
        ...
        await resend.emails.send({
          from: "Platinum Accolades <noreply@platinumaccolades.com>",
          to: [email],
          subject: "We received your consultation request | Platinum Accolades",
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
              <div style="background: linear-gradient(135deg, #0F2545, #0F2F57); padding: 40px; border-radius: 12px 12px 0 0; text-align: center;">
              ...
              <div style="background: #F8F4F0; padding: 32px; border-radius: 0 0 12px 12px; border: 1px solid #dde4d0;">
                <p style="color: #5f6b58; line-height: 1.7;">
                  Thank you for reaching out to Platinum Accolades. We're excited to learn more about your goals and how we can help you get there.
                </p>
                <p style="color: #5f6b58; line-height: 1.7;">
                ...
                <div style="background: #eef2e8; border-left: 4px solid #14325E; padding: 16px; border-radius: 0 8px 8px 0; margin: 24px 0;">
                  <p style="margin: 0; color: #0F2F57; font-weight: bold;">Your Request Summary</p>
                  <p style="margin: 8px 0 0; color: #5f6b58;">Service: ${service}</p>
                </div>
                <p style="color: #5f6b58; margin-top: 24px;">
                  In the meantime, feel free to explore our <a href="#" style="color: #0F2F57;">blog</a> for student support insights.
                </p>
                <p style="color: #94a3b8; font-size: 14px; margin-top: 32px;">
                  Platinum Accolades | Gaborone, Botswana<br>
                  <a href="tel:+26776150511" style="color: #94a3b8;">+267 76150511</a> /
